 ...
 */
//
//  MixfaderDetailViewController.h
//  MixfaderSample
//
...
@interface MixfaderDetailViewController : UIViewController

@property (weak, nonatomic) IBOutlet UIView *headerView;

@property (nonatomic, weak) IBOutlet NSLayoutConstraint *knobCenterConstraint;
