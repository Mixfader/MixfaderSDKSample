...
@interface MixfaderLedTableViewCell ()

@property (nonatomic, weak) MXFMixfaderInterface *interface;

@end

@implementation MixfaderLedTableViewCell
...
- (IBAction)onBlinkLedButton:(id)sender {
	[self.interface blinkLedWithCompletion:^(NSError * _Nullable error) {
		if(error)
		{
