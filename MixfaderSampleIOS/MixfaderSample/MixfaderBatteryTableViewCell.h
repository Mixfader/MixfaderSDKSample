 ...
 */
//
//  MixfaderBatteryTableViewCell.h
//  MixfaderSample
//
...
@interface MixfaderBatteryTableViewCell : MixfaderTableViewCell

@property (weak, nonatomic) IBOutlet UISwitch *chargingSwitch;
@property (weak, nonatomic) IBOutlet UILabel *batteryValueLabel;
@property (weak, nonatomic) IBOutlet UIProgressView *batteryProgressValue;
